...
if len(part_options) == 1:
    ...
    if part_options[0] == 'Processor':
        if options_pref == 'Performance':
            ...
            st.table(result)
            #st.write("1. ", CPU_data.iloc[indices[-1]]['name'],"-",int(sysScore[indices[-1]]))
            #st.write("2. ", CPU_data.iloc[indices[-2]]['name'],"-",int(sysScore[indices[-2]]))
            #st.write("3. ", CPU_data.iloc[indices[-3]]['name'],"-",int(sysScore[indices[-3]]))
            #st.write("4. ", CPU_data.iloc[indices[-4]]['name'],"-",int(sysScore[indices[-4]]))
            #st.write("5. ", CPU_data.iloc[indices[-5]]['name'],"-",int(sysScore[indices[-5]]))
            ...
            for i in range(5):
                if i == 0:
                    result = pd.concat([result,(pd.Series([CPU_data.iloc[indices[-(i+1)]]['name'], int(CPU_data.iloc[indices[-(i+1)]]['CPUMark']), int(sysScore[indices[-(i+1)]]), CPU_data.iloc[indices[-(i+1)]]['price']]))],ignore_index=True)
                else:
                    result = pd.concat([result,(pd.Series([CPU_data.iloc[indices[-(i+1)]]['name'], int(CPU_data.iloc[indices[-(i+1)]]['CPUMark']), int(sysScore[indices[-(i+1)]]), CPU_data.iloc[indices[-(i+1)]]['price']]))], axis=1,ignore_index=True)
            result.index = [part_options[0] + " name", "Performance score", "Value Score(/$)", "Price"]
            result= result.T
            result.index = ["1","2","3","4","5"]
            st.table(result)
    ...
    #        st.write("5. ", CPU_data.iloc[indices[-5]]['name'],"-",int(sysScore[indices[-5]]))
        ...
        if options_pref == 'Performance':
            ...
            #st.write("1.", GPU.iloc[indices[-1]]['name'],"-",int(sysScore[indices[-1]]))
            #st.write("2.", GPU.iloc[indices[-2]]['name'],"-",int(sysScore[indices[-2]]))
            #st.write("3.", GPU.iloc[indices[-3]]['name'],"-",int(sysScore[indices[-3]]))
            #st.write("4.", GPU.iloc[indices[-4]]['name'],"-",int(sysScore[indices[-4]]))
            #st.write("5.", GPU.iloc[indices[-5]]['name'],"-",int(sysScore[indices[-5]]))
        elif options_pref == 'Value':
...
#            st.write("1.", GPU_price.iloc[indices[-1]]['name'],"-",int(sysScore[indices[-1]]))
#            st.write("2.", GPU_price.iloc[indices[-2]]['name'],"-",int(sysScore[indices[-2]]))
#            st.write("3.", GPU_price.iloc[indices[-3]]['name'],"-",int(sysScore[indices[-3]]))
#            st.write("4.", GPU_price.iloc[indices[-4]]['name'],"-",int(sysScore[indices[-4]]))
#            st.write("5.", GPU_price.iloc[indices[-5]]['name'],"-",int(sysScore[indices[-5]]))
        ...
        if options_pref == 'Performance':
            ...
            indices = np.argsort(sysScore)
        st.write("1.", HDDSDD.iloc[indices[-1]]['name'],"-",int(sysScore[indices[-1]]))
        st.write("2.", HDDSDD.iloc[indices[-2]]['name'],"-",int(sysScore[indices[-2]]))
        st.write("3.", HDDSDD.iloc[indices[-3]]['name'],"-",int(sysScore[indices[-3]]))
        st.write("4.", HDDSDD.iloc[indices[-4]]['name'],"-",int(sysScore[indices[-4]]))
        st.write("5.", HDDSDD.iloc[indices[-5]]['name'],"-",int(sysScore[indices[-5]]))
        ...
        if options_pref == 'Performance':
            ...
            indices = np.argsort(sysScore)
        st.write("1.", RAM_data.iloc[indices[-1]]['name'],"-",int(sysScore[indices[-1]]))
        st.write("2.", RAM_data.iloc[indices[-2]]['name'],"-",int(sysScore[indices[-2]]))
        st.write("3.", RAM_data.iloc[indices[-3]]['name'],"-",int(sysScore[indices[-3]]))
        st.write("4.", RAM_data.iloc[indices[-4]]['name'],"-",int(sysScore[indices[-4]]))
        st.write("5.", RAM_data.iloc[indices[-5]]['name'],"-",int(sysScore[indices[-5]]))
else:
